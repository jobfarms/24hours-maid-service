# 24Hours Maid Services - Project TODO

## Phase 1: Database Schema & Foundation
- [x] Comprehensive Prisma schema with all tables (users, maids, bookings, payments, wallets, OTP, audits)
- [x] Database migrations and schema push
- [x] Encryption utilities for sensitive data

## Phase 2: Backend API & Security
- [x] OTP authentication system (SHA-256 hashing with salt)
- [x] JWT token management with refresh token rotation
- [x] Role-based authorization (customer, maid, admin, super admin)
- [x] Payment gateway integration (Razorpay + Stripe)
- [x] Real-time notification system
- [x] Admin audit logging system
- [x] Wallet and earnings calculation system
- [x] Availability tracking system

## Phase 3: Customer Booking Interface
- [x] Customer authentication flow (OTP + Google login)
- [x] Service selection interface (maid, babysitter, caretaker, etc.)
- [x] Date & time picker component
- [ ] Live maid availability display
